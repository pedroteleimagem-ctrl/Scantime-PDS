...
class ConstraintsTable(tk.Frame):
    ...
    def _build_controls(self):
        ...
        tk.Button(controls, text="Ajouter", command=self.add_row).pack(side="left", padx=4)
        tk.Button(controls, text="Supprimer", command=self.delete_row).pack(side="left", padx=4)
